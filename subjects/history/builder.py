...
from subjects.history.metrics import empty_metrics_history, extract_metrics, merge_metrics_history, metrics_to_row
...
async def _process_single_course(course, token, study_month, client, semaphore):
    ...
    try:
        ...
        if not group_results:
            return None
        course_avg = merge_metrics_history([gr["monthly"] for gr in group_results])
